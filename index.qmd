...
<small>Stat. learning for life science<br/> Paris-Saclay University, INRAE</small>
:::
:::
...
#### Pierre Neuvial <small>(chief editor)</small>

<small>Statistics<br/> CNRS, IMT Toulouse</small>
:::
:::

::: {.column width="20%"}
::: people
![](./people/mathieu.jpg){width="120"}

#### Mathieu Carrière

<small>Topological data analysis<br/> Inria, Sophia Antipolis</small>
:::
:::
...
<small>Research Engineer, IA for Microelectronics<br/> LIRMM, CNRS, Montpellier</small>
:::
:::
:::
...
<small>Research Engineer, Statistics<br/> LMJL Nantes, CNRS</small>
:::
:::
...
<small>Statistical methods for ecology<br/> ENSAI CREST, Rennes</small>
:::
:::
...
<small>ML and causal inference for genomics<br/> CNRS, Grenoble Alpes</small>
:::
:::
...
<small>ML for therapeutic research<br/> Mines ParisTech</small>
:::
:::
:::
...
<center>[![](img/computo_website.png){height="280px"}](https://computo-journal.org) [![](img/computo_github-group.png){height="280px"}](https://github.com/computorg/)</center>
...
-   🔄 Ongoing migration to *Peer Community In* system
    -   Former system: OpenReview
    -   New system: <https://computo-journal.org/> and <https://statml.peercommunityin.org/>
:::
...
[Git `template` repository](https://computo-journal.org/site/guidelines-authors.html#sec-templates)

with template notebook document + doc + pre-configured compilation and publication setup

[![](img/computo_template_repositories.png)](https://computo-journal.org/site/guidelines-authors.html#sec-templates)
:::
:::
...
#### Submission system (migrating to PCI)

The editorial process is migrating from OpenReview to the *Peer Community In* platform:

-   Former platform: <https://openreview.net/group?id=Computo>
-   New platform: <https://computo-journal.org/> and <https://statml.peercommunityin.org/>
...
🙂 7 published articles, 3 in pre-production, 6 under review (more details [here](https://computo-journal.org/publications/))
...
## Partnership with PCI StatML

### 🤝 What is PCI StatML?

**PCI StatML** (<https://statml.peercommunityin.org/>)

-   📝 **Free, community-driven** peer review platform
-   🎯 Scope: statistics and machine learning
-   🤝 Computo is a [*PCI-friendly* journal](https://peercommunityin.org/pci-friendly-journals/)

### 🔄 Current Submission Process

**Direct submission to Computo via OpenReview**

1.  Submit via OpenReview (<https://openreview.net/group?id=Computo>)
2.  Peer review + **reproducibility test** (formatting, code, data)
3.  Publication in Computo

### 🔮 Future: PCI → Computo Route

Once PCI integration is fully operational:

1.  Submit to PCI StatML
2.  Peer review (PCI)
3.  PCI recommendation
4.  **Reproducibility test** Computo (no additional scientific review)
5.  Publication in Computo

<br/>

---

## Partnership with PCI StatML (continued)
...
-   ✅ **OpenReview**: currently active for all Computo submissions
-   🤝 **PCI partnership**: launched, but not yet operational for submissions
-   ⚠️ **Migration**: PCI platform integration ongoing (details TBD: submission format, HAL deposition, etc.)
-   🚀 **Future benefit**: accelerated process for PCI-recommended articles (scientific review waived, reproducibility test only)
...
-   [rOpenSci](https://ropensci.org/) / [pyOpenSci](https://www.pyopensci.org/)[^5]: software peer review for R/Python packages
    -   📦 **Focus**: package quality, documentation, API design, testing
    -   🤝 **Complementary to Computo**: rOpenSci reviews *software packages*, Computo publishes *scientific articles* with reproducible computations
    -   📰 **Blog post**: ["Computo - A Journal for Transparent and Reproducible Research"](https://ropensci.org/blog/2025/11/06/computo-journal-reproducible-research-statistics-machine-learning/)
-   [EpiSciences](https://www.episciences.org/): peer review and publication, but not reproducible by default
...
[^5]: See previous slides for PCI StatML partnership details.
...
[^6]: <https://computo-journal.org/submit/>
